...
2) Make sure your test suite always passes at 100%.

Of course after you already wrote your tests for a new feature but before you
can write the actual code there is a short time period when your test suite will
not pass 100%.
...
In order to make the test suite happy there is a way to tell the harness tool that a test
