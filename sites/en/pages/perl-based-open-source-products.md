...
<!--
Unfortunately it seems it has not been maintained for a while. Some of the links on the site don't work any more.
Last time I checked, the [Blosxom](http://www.blosxom.com/) site was down.
-->
...
[Dreamwidth](http://www.dreamwidth.org/) is a community system for shared blogging. It was forked from the last open source version of Live Journal.
...
[Sympa](http://sympa.org/) is a program for managing mailing lists. You can find the list of companies providing [commercial support for Sympa](https://www.sympa.org/technical_support).

[Dada Mail](http://dadamailproject.com/) is a program for managing mailing lists. They provide some commercial services but as I can see it is well hidden on the site and I don't think anyone is making a living out of that.
...
[Yaala](http://www.yaala.org/) is an analyzer for all kinds of logfiles. As I can see there has been no major activity on the mailing list at all.
...
with transaction management capability. There is a list of [companies providing commercial support for Interchange](http://www.icdevgroup.org/i/dev/support/index).
...
(Authentication Authorization Accounting) (I have to admit I am not sure what does that mean.) This is the other web site that would be the winner for being beautiful.
...
[Anti-Spam SMTP Proxy (ASSP)](http://sourceforge.net/apps/mediawiki/assp/) is a platform-independent transparent SMTP proxy server. [Wikipedia](https://en.wikipedia.org/wiki/Anti-Spam_SMTP_Proxy). (The assp.sourceforge.net link was redirecting.)
...
system. Commercial support is provided by a number of companies, all of them in France. The source code is available on [CPAN](https://metacpan.org/author/FUSINV) as well.


## Tools for developers

[Tinderbox](http://en.wikipedia.org/wiki/Tinderbox_%28software%29) is a tool to help continuous integration
by running build on several machines. For a long time it was developed and maintained by Mozilla, but if I am not mistaken it is now handled elsewhere. It does not seem to have a "home".
...
[Perl Application Development and Refactoring Environment](http://padre.perlide.org) (Padre) is an Integrated Development Environment (IDE) written in Perl for Perl developers.
...
<!--
[Cubrid](http://www.cubrid.org/wiki_apps/entry/qdepo-cubrid-tutorial) is an open source database.
-->
...
[Tpda3 (Tiny Perl Database Application 3)](http://tpda.s2i2.ro/) A classic desktop database application framework and run-time.  [Sourceforge](http://sourceforge.net/projects/tpda/)
...
and [Perlbal on CPAN](https://metacpan.org/release/Perlbal).
...
[FEX](http://fex.rus.uni-stuttgart.de/) Frams' Fast File EXchange. Web-based sending of files
...
<!--
http://www.vromans.org/johan/software.html

https://www.booking.com/

TODO: https://www.socialtext.net/perl5/Applications
TODO: http://en.wikipedia.org/wiki/Category:Perl_software

AxKit - has been retired in 2009

-->

## Not Open Source

There are a number of non-open source Perl-based products. I am going to create a separate list of those too, for now let me list them here:
